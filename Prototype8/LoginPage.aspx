...
<body style="width: 800px; height: 575px; background-color: rgb(40, 40, 40); max-width: 500px; margin:10% auto;">
    <form id="LoginForm" runat="server">
        ...
        <asp:Panel ID="pnlLogin" runat="server" style="z-index: 1; height: 505px; width: 400px; background-color: rgb(70, 70, 70); max-width: 500px; max-height: 500px; margin:50px, auto; position:relative">
            ...
            <asp:Panel ID="pnlUN" runat="server" style = "position:absolute; left: 75px; top: 136px; background-color: rgb(64, 66, 51); width: 250px; height: 45px">
                <asp:TextBox ID="txtLoginUsername" runat="server" style = "position:absolute; left: 10px; top: 12px; width:227px; background-color: rgb(64, 66, 51);"
                    Font-Bold="False" Font-Names="Segoe UI" Font-Size="12pt" ForeColor="White" BorderStyle ="None">
                </asp:TextBox>
            </asp:Panel>

            <asp:Panel ID="pnlPW" runat="server" style = "position:absolute; left: 75px; top: 247px; background-color: rgb(64, 66, 51); width: 250px; height: 45px">
